...
4. Output must be a single object with four properties:
   ...
   - \`trace \`:an array of trace objects that simulate the step-by-step execution. accoeding to the input graph or array this should have proper dry run acc to the template
